...
export enum Permission {
    ...
    LEADS_VIEW_NEW = 'leads.view_new',
    LEADS_VIEW_VERIFIED = 'leads.view_verified',
    LEADS_VIEW_NEEDS_REVIEW = 'leads.view_needs_review',
    LEADS_VIEW_NEEDS_CALL = 'leads.view_needs_call',
    LEADS_VIEW_SENT = 'leads.view_sent',
    LEADS_VIEW_SOLD = 'leads.view_sold',
    LEADS_VIEW_TRASH = 'leads.view_trash',
