...
export default class JobResource {
    ...
    private initializeRoutes() {
        ...
        // Get a specific job
        this.router.get("/admin/:jobId", async (req: Request, res: Response) => {
        ...
        // Update a job
        this.router.patch("/admin/:jobId", async (req: Request, res: Response) => {
            const jobId = req.params.jobId;
        ...
        // Run a job
        this.router.post("/admin/:jobId/run", async (req: Request, res: Response) => {
            const jobId = req.params.jobId;
        ...
        // Pause a job
        this.router.post("/admin/:jobId/pause", async (req: Request, res: Response) => {
            const jobId = req.params.jobId;
        ...
        // Resume a job
        this.router.post("/admin/:jobId/resume", async (req: Request, res: Response) => {
            const jobId = req.params.jobId;
        ...
        // Delete a job
        this.router.delete("/admin/:jobId", async (req: Request, res: Response) => {
            const jobId = req.params.jobId;
